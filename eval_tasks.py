...
def main(args):
    ...
    with open(ctxdb_path, 'r') as f:
        ctxdb = json.load(f)
    # Build dataloaders
    val_dataset = ViLBERTDataset(refdb, ctxdb, split=args.split, roi_per_img=CONFIG['ROI_PER_IMG'])
    ...
    for i, task_id in enumerate(args.tasks.split("-")):
        ...
        task_batch_size[task] = args.batch_size
...
if __name__ == "__main__":
    ...
    parser.add_argument('--conf', default=1, type=float, required=True)
